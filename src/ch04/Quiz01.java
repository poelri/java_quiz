    ...
    public static void main(String[] args) {
        /*
            ...
            다음 문장들을 조건식으로 표현하시오.
             ...
             4. char형 변수 ch가 숫자(‘0’~‘9’)일 때 trgit add .ue인 조건식 -> ch >= 0 || ch <= 9
             5. char형 변수 ch가 영문자(대문자 또는 소문자)일 때 true인 조건식 ch == lower || ch == upper
             ...
             8. 문자열 참조변수 str이 “yes”일 때 true인 조건 "yes".equals(str)
